...
library(psy); library(tidyverse); library(lavaan); library(psych); library(knitr); library(DT); library(Hmisc); library(xtable)
# library(caret)
```
...
```{r Confirmatory Factor Analysis - Teaching, message=FALSE, warning=FALSE, echo = FALSE}
...
```{r Confirmatory Factor Analysis - Caring, message=FALSE, warning=FALSE, echo=FALSE}
...
kable(Finances.cor.matrix$r, caption = "Table 8: Relationships between Income and Payment Methods")
```
